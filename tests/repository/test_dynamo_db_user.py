...
class TestDynamoDbUserRepository(TestCase):
    ...
    def test_get_user(self):
        ...
        dynamodb_user_repository = DynamoDbUserRepository(
            client=client_mock, serializer=serializer_mock
        )
    ...
    def test_get_user_exception(self):
        client_mock = MagicMock()
        client_mock.get_item.return_value = {"ResponseMetadata": {"HTTPStatusCode": 0}}
    ...
    def test_save_user(self):
        ...
        serializer_mock.serialize.assert_called_once_with(
    ...
    def test_save_user_exception(self):
        ...
        client_mock = MagicMock()
        client_mock.update_item.return_value = {
            "ResponseMetadata": {"HTTPStatusCode": 0}
        }
